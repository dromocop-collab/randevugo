...
export default function BusinessesPage() {
  return <BusinessPage className="business-landing"><main>
    <section className="business-hero"><div className="business-hero-art" /><div className="business-hero-overlay" /><div className="business-hero-content"><div className="business-eyebrow"><Sparkles size={14} /> Türkiye&apos;nin yeni nesil işletme çalışma alanı</div><h1>Takviminizi değil,<br /><em>işletmenizi büyütün.</em></h1><p>Randevu, ekip, müşteri ve gelir operasyonunuzu tek akıllı sistemde birleştirin. Siz hizmetinize odaklanın; SeninRandevun geri kalanını akıcı hâle getirsin.</p><div className="business-hero-actions"><Link href="/isletmeler/kayit">İlk yıl ücretsiz başla <ArrowRight size={16} /></Link><Link href="/ozellikler">Ürünü keşfet</Link></div><div className="business-hero-proof"><span><Check size={13} /> Kredi kartı gerekmez</span><span><Check size={13} /> Kurulum desteği dahil</span><span><Check size={13} /> İstediğin zaman ayrıl</span></div></div><div className="business-floating-stat stat-one"><Gauge size={18} /><div><b>%84</b><small>doluluk oranı</small></div></div><div className="business-floating-stat stat-two"><BarChart3 size={18} /><div><b>+%27</b><small>aylık büyüme</small></div></div></section>
    ...
    <section className="business-final-cta"><span>İLK 12 AY BOYUNCA TÜM ÖZELLİKLER AÇIK</span><h2>Yarının işleyişini<br />bugün kurun.</h2><p>Kredi kartı yok. Kurulum ücreti yok. Sadece daha akıcı bir işletme deneyimi.</p><Link href="/isletmeler/kayit">Ücretsiz hesabını aç <ArrowRight size={17}/></Link></section>
  </main></BusinessPage>;
}
