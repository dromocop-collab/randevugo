...
export const metadata: Metadata = { title: "İşletme Kaydı", description: "İşletmeniz için 14 günlük ücretsiz SeninRandevun çalışma alanı oluşturun.", robots: { index: false, follow: false } };
