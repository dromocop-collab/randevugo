...
interface CustomerAppointment { id:string; businessId:string; businessName:string; businessSlug:string; businessLogo?:string; businessCity:string; businessPhone:string; serviceId:string; staffId:string; serviceName:string; staffName:string; startAt:string; endAt:string; status:string; publicToken?:string; price?:number }
interface SuspendedBusiness { id: string; name: string; adminNote?: string }
type AccountTab = "overview" | "appointments" | "alerts" | "favorites" | "profile";
