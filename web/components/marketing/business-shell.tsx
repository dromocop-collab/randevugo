...
export function BusinessPage({ children, className = "" }: { children: ReactNode; className?: string }) { return <div className={`business-marketing ${className}`}><LaunchCampaign /><BusinessHeader />{children}<BusinessFooter /></div>; }
